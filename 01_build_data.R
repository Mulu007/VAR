# =====================================================================
# 01_build_data.R
# Download BLS PPI source files, build roster + coverage table, and
# construct the balanced analysis panel (2004:01 onward).
# Inputs : BLS downloads -> data/raw/
# Outputs: data/processed/{analysis_panel_levels,ppi_long,roster}.rds,
#          tables/ppi_coverage.tex
# =====================================================================
library(readr)
library(tidyverse)
library(xtable)
